...
<body class="w3-light-grey">
    ...
    <nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
        ...
        <div class="w3-bar-block">
            ...
            <a href="manage_users.php" class="w3-bar-item w3-button w3-padding w3-blue"><i class="fas fa-users"></i> 
                Manage Users</a>
    ...
    <div class="w3-main" style="margin-left:300px;margin-top:43px;">
        ...
        <header class="w3-container" style="padding-top:22px">
            <h5><b><i class="fas fa-users"></i> Manage Users</b></h5>
        </header>

        <header class="w3-container" style="padding-top:22px">
            <h5 style="margin-left: 30px;"><i class="far fa-trash-alt"></i> Remove User</h5>
        </header>
                ...
                <tr>
                    <form action="Controllers/php/php_removeUser.php" method="POST">
                        <td style="padding: 10px;"><input class="w3-input" type="text" name="uname"
                                placeholder="User name" list="userlist" required></td>
                        <td style="padding: 10px;"><button class="w3-button w3-red" name="remove">Remove user</button>
                        </td>
                    </form>
        ...
        <header class="w3-container" style="padding-top:22px">
            <h5 style="margin-left: 30px;"><i class="fas fa-clipboard-list"></i> User details <label
                    id="ucountval"></label></h5>
        </header>
        ...
        <div class="w3-row-padding w3-margin-bottom" style="padding: 60px;overflow-x:auto;max-height: 500px;">
            <table id="usertb">
                ...
                echo '
                <script>
                        document.getElementById("ucountval").innerHTML = "('.$ucount.')";
                </script>
                ';
